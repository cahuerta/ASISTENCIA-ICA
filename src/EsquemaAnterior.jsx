...
export default function EsquemaAnterior({
  ...
  const puntos = {
    ...
    pantallaIzq_hombro: { cx: VB * 0.34, cy: VB * 0.08, rx: 44, ry: 44 },
    pantallaDer_hombro: { cx: VB * 0.66, cy: VB * 0.08, rx: 44, ry: 44 },

    // Codos (más chico que hombro)
    pantallaIzq_codo: { cx: VB * 0.30, cy: VB * 0.3, rx: 38, ry: 38 },
    pantallaDer_codo: { cx: VB * 0.60, cy: VB * 0.3, rx: 38, ry: 38 },
