...
export default function EsquemaAnterior({
  ...
  const puntos = {
    ...
    pantallaIzq_hombro: { cx: VB * 0.34, cy: VB * 0.04, rx: 44, ry: 44 },
    pantallaDer_hombro: { cx: VB * 0.66, cy: VB * 0.04, rx: 44, ry: 44 },

    // Codos (más chico que hombro) — MÁS ARRIBA (cy 0.45)
    pantallaIzq_codo: { cx: VB * 0.28, cy: VB * 0.4, rx: 38, ry: 38 },
    pantallaDer_codo: { cx: VB * 0.72, cy: VB * 0.4, rx: 38, ry: 38 },

    // Manos (más chicas que codo) — MÁS ARRIBA (cy 0.63)
    pantallaIzq_mano: { cx: VB * 0.24, cy: VB * 0.6, rx: 32, ry: 32 },
    pantallaDer_mano: { cx: VB * 0.76, cy: VB * 0.6, rx: 32, ry: 32 },
