// src/tobillo/usetobilloypiestate.js
import { useState, useCallback } from "react";

/**
 * Estado mínimo para la marcación de tobillo y pie.
 * - Punto: { x: number(0..1), y: number(0..1), key: string, selected: boolean }
 * - Solo togglear selección de puntos predispuestos.
 */
export function useTobilloPieState(initialPoints = []) {
  ...
  return {
    puntos,
    setPuntos,   // se usa para precargar desde TOBILLOPIE_PUNTOS_BY_VISTA
