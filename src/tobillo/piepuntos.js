...
export const PIE_PUNTOS_FRENTE = [
  { key: "fr_maleolo_medial",  x: 0.68, y: 0.39, label: "Maléolo medial" },
  ...
  { key: "fr_dorso_mt2",       x: 0.48, y: 0.97, label: "Dorso 2.º metatarsiano" },
];
...
export const PIE_PUNTOS_POSTERIOR = [
  ...
  { key: "po_maleolo_lat",   x: 0.42, y: 0.64, label: "Maléolo lateral (posterior)" },
  { key: "po_centro_talon",  x: 0.45, y: 0.98, label: "Centro del talón" },
];

// ==== VISTA PLANTAR ====
export const PIE_PUNTOS_PLANTAR = [
  { key: "pl_ins_fascia",     x: 0.55, y: 0.28, label: "Inserción fascia en calcáneo" },
  ...
  { key: "pl_centro_antepie", x: 0.55, y: 0.83, label: "Centro plantar del antepié" },
];
