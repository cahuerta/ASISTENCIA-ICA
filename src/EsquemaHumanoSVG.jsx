  ...
  return (
    ...
    >
      ...
      <ellipse
        ...
        cursor="pointer"
      />
      <text x="50" y="245" fontSize="10" fill="#333">Cadera izq.</text>
      ...
      <ellipse
        ...
        cursor="pointer"
      />
      <text x="160" y="245" fontSize="10" fill="#333">Cadera der.</text>
      ...
      <circle
        ...
        cursor="pointer"
      />
      <text x="40" y="430" fontSize="10" fill="#333">Rodilla izq.</text>
      ...
      <circle
        ...
        cursor="pointer"
      />
      <text x="160" y="430" fontSize="10" fill="#333">Rodilla der.</text>
    </svg>
  );
}
