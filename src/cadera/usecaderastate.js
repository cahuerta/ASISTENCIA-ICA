// src/cadera/usecaderastate.js
import { useState, useCallback } from "react";

/**
 * Estado mínimo para la marcación de cadera.
 * - Punto: { x: number(0..1), y: number(0..1), key: string, selected: boolean }
 * - Solo togglear selección de puntos predispuestos.
 */
export function useCaderaState(initialPoints = []) {
  ...
  return {
    puntos,
    setPuntos,   // se usa para precargar desde CADERA_PUNTOS_BY_VISTA
