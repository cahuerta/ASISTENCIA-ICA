...
export const CADERA_PUNTOS_ANTERIOR = [
  { key: "eias",             x: 0.65, y: 0.25, label: "Espina ilíaca anterosuperior (EIAS)" },
  { key: "region_inguinal",  x: 0.55, y: 0.45, label: "Región inguinal (iliopsoas)" },
  { key: "trocanter_mayor",  x: 0.70, y: 0.60, label: "Trocánter mayor" },
  { key: "aductores_pubis",  x: 0.50, y: 0.58, label: "Origen aductores (pubis)" },
  { key: "sinfisis_pubica",  x: 0.50, y: 0.62, label: "Sínfisis púbica" },
];

export const CADERA_PUNTOS_POSTERIOR = [
  { key: "sacroiliaca",          x: 0.57, y: 0.30, label: "Articulación sacroilíaca" },
  { key: "bursa_trocanterica",   x: 0.70, y: 0.58, label: "Bursa trocantérica" },
  { key: "piriforme",            x: 0.62, y: 0.48, label: "Piriforme" },
  { key: "isquiotibiales_prox",  x: 0.58, y: 0.74, label: "Tendones isquiotibiales proximales" },
];
