...
export default function EsquemaPosterior({
  ...
  const nuevos = {
    ...
    tobilloIzq:{ cx: VB * 0.41, cy: VB * 1.055, rx: 38, ry: 38, label: "Tobillo izquierda" },
    tobilloDer:{ cx: VB * 0.59, cy: VB * 1.055, rx: 38, ry: 38, label: "Tobillo derecha" },
  };

  // ===== Columnas adicionales (sin lado) =====
  // Mismo estilo que lumbar; ubicadas por encima de lumbar
  const cervical = { x: VB * 0.5 - 34, y: VB * 0.0000001,  w: 68,  h: 65,  rx: 10, label: "Columna cervical" };
